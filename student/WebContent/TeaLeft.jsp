      ...
      <table width="212" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td><table width="212" height="20" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td width="212" height="32" background="images/default_09.gif" onClick="javascript:openspgl()"><div align="center"><img id="d1" border="0"src="images/point1.gif" width="10" height="10"><a href="#">课程安排</a></div></td>
            </tr>
          </table>
            <table width="212" border="0" cellpadding="0" cellspacing="0" id="spgl" style="display:">
              <tr>
                <td height="20" background="images/default_10.gif"><div align="center"><a href="ShowMajor_coure.jsp" target="main">成绩管理</a></div></td>
              </tr>
            </table>
			</td>
        </tr>
        ...
        <td>
         <table width="212" height="20" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td height="32" background="images/default_09.gif" onClick="javascript:openyhgl()"><div align="center"><a href="#"><img id="d2" border="0"src="images/point1.gif" width="10" height="10"> 个人信息</a></div></td>
              </tr>
            </table>
            <table width="212" border="0" cellpadding="0" cellspacing="0" id="yhgl" style="display:">
              <tr>
                <td height="26" background="images/default_10.gif"><div align="center"><a href="TeaUpdate.jsp" target="main">修改密码</a></div></td>
              </tr>
            </table>
            </td>
            </tr>
